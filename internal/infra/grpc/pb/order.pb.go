...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x32, 0x77, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73,
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	...
	1, // 1: pb.ListOrders.CreateOrder:input_type -> pb.CreateOrderRequest
	0, // 2: pb.ListOrders.ListOrders:input_type -> pb.blank
	2, // 3: pb.ListOrders.CreateOrder:output_type -> pb.OrderResponse
	3, // 4: pb.ListOrders.ListOrders:output_type -> pb.ListOrdersResponse
